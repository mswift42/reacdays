...
{return (function() { 
var G__14638__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
var args = cljs.core.seq(arglist__14639);
...
reagent.impl.template.undash_prop_name = (function undash_prop_name(n){var or__8734__auto__ = reagent.impl.template.attr_aliases.call(null,n);if(cljs.core.truth_(or__8734__auto__))
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__14641 = res;(G__14641[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__14641;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__14642){var vec__14644 = p__14642;var id = cljs.core.nth.call(null,vec__14644,(0),null);var class$ = cljs.core.nth.call(null,vec__14644,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_14645 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_14645 === "key")))
{(o[pname_14645] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__14648 = jsprops;(G__14648["defaultValue"] = value);
(G__14648["value"] = null);
(G__14648["onChange"] = ((function (G__14648,on_change,value){
return (function (p1__14646_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14646_SHARP_);
});})(G__14648,on_change,value))
);
return G__14648;
}
});
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__14654 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__14654,(0),null);var id = cljs.core.nth.call(null,vec__14654,(1),null);var class$ = cljs.core.nth.call(null,vec__14654,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__8734__auto__ = id;if(cljs.core.truth_(or__8734__auto__))
{return or__8734__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__14656 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__14656,(0),null);var id_class = cljs.core.nth.call(null,vec__14656,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj14660 = {};(obj14660[reagent.impl.util.cljs_argv] = v);
(obj14660[reagent.impl.util.cljs_level] = level);
return obj14660;
})();var k_14661 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__14662 = (((k_14661 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_14661);if((k_SINGLEQUOTE__14662 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__14662);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__9604__auto___14663 = a.length;var i_14664 = (0);while(true){
if((i_14664 < n__9604__auto___14663))
{(a[i_14664] = reagent.impl.template.as_component.call(null,(a[i_14664]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__9604__auto___14666 = a.length;var i_14667 = (0);while(true){
if((i_14667 < n__9604__auto___14666))
{if((i_14667 >= first_child))
{(a[i_14667] = reagent.impl.template.as_component.call(null,(a[i_14667]),level));
} else
{}
{
