...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__8734__auto__ = w.requestAnimationFrame;if(cljs.core.truth_(or__8734__auto__))
{return or__8734__auto__;
} else
{var or__8734__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__8734__auto____$1))
{return or__8734__auto____$1;
} else
{var or__8734__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__8734__auto____$2))
{return or__8734__auto____$2;
} else
{var or__8734__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__8734__auto____$3))
...
var n__9604__auto__ = a.length;var i = (0);while(true){
if((i < n__9604__auto__))
{var C_14621 = (a[i]);if(cljs.core.truth_(C_14621.cljsIsDirty))
{C_14621.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__9311__auto__,writer__9312__auto__,opt__9313__auto__){return cljs.core._write.call(null,writer__9312__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__8722__auto__ = !((C == null));if(and__8722__auto__)
{var and__8722__auto____$1 = (C["props"]);if(cljs.core.truth_(and__8722__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_14623 = C.cljsRatom;if(!((ratom_14623 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_14623);
} else
{}
